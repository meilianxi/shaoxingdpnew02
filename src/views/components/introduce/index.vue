<template>
      <div class="introduce-index">
        ...
        <div v-if="theme=='introduce'">
            <img src="../../../assets/img/a-intro.png" id="pic_introduce" style="width:100%;height:927px">
        </div>

         <div v-if="theme=='intelligence'">
              <img src="../../../assets/img/b-intro.png" id="pic_intelligence" style="width:100%;height:927px">
        </div>
...
export default {
  ...
  data(){
    return {
      showPic:"../../../assets/img/c-intro.png",
      pic_urls:[
      //   {
      //   code:1,
      //   activeIndex:1,
      ...
      // },
      {
        code:3,
        activeIndex:3,
        url:"../../../assets/img/c-intro.png"
      },{
        code:4,
        activeIndex:0,
        url:"../../../assets/img/d-intro.png"
      }]
    }
  },
  created() {
