<template>
  <div class="front-bottom">
    <div class="icon-wrapper" v-if="theme == 'check'">
      <div class="sg-icon">
        <div
          style="float:left;margin-left:-2px;margin-top:-2px;border-top:solid 2px #01cef6;width:16px"
        ></div>
        <div
          style="float:right;margin-right:-2px;margin-top:-2px;border-top:solid 2px #01cef6;width:16px"
        ></div>
        <div class="sg-pot"></div>
        <div class="sg-text">当前供水量（万m3）</div>
        <div class="sg-num">
          <!-- {{sldata.todaysupplyFlux}} -->
          23
        </div>
        <div class="clear">
          <div
            style="float:left;margin-left:-2px;border-top:solid 2px #01cef6;border-radius:5px;width:16px"
          ></div>
          <div style="float:right;margin-right:20px;border-top:solid 2px #01cef6;width:16px"></div>
        </div>
      </div>
      <div class="sg-icon">
        <div
        ...
        ></div>
        <div class="sg-pot"></div>
        <div class="sg-text">昨日总供水量（万m3）</div>
        <div class="sg-num">
          <!-- {{sldata.yesterdaysupplyFlux}} -->
          31.3
        </div>
        <div class="clear">
          <div
      ...
      <div class="sg-icon">
        ...
        ></div>
        <div class="sg-pot"></div>
        <div class="sg-text">最高日供水量（万m3）</div>
        <div class="sg-num">35</div>
        <div class="clear">
          <div
            style="float:left;margin-left:-2px;border-top:solid 2px #01cef6;border-radius:5px;width:16px"
          ></div>
      ...
      <div class="sg-icon">
        ...
        ></div>
        <div class="sg-pot"></div>
        <div class="sg-text">中心区压力（MPa）</div>
        <div class="sg-num">
          <!-- {{centerPressure}} -->
          0.28
        </div>
      ...
      <div class="sg-icon">
        ...
        ></div>
        <div class="sg-pot"></div>
        <div class="sg-text">末梢压力（MPa）</div>
        <div class="sg-num">0.24</div>
        <div class="clear">
          <div
            style="float:left;margin-left:-2px;border-top:solid 2px #01cef6;border-radius:5px;width:16px"
          ></div>
      ...
      <div class="sg-icon">
        ...
        ></div>
        <div class="sg-pot"></div>
        <div class="sg-text">当前排水量（万m3）</div>
        <div class="sg-num">
          <!-- {{sldata.todaypumpFlux}} -->
          31
        </div>
        <div class="clear">
          <div
      ...
      <div class="sg-icon">
        ...
        ></div>
        <div class="sg-pot"></div>
        <div class="sg-text">昨日总排水量（万m3）</div>
        <div class="sg-num">
          <!-- {{sldata.yesterdaypumpFlux}} -->
          34
        </div>
        <div class="clear">
          <div
      ...
      <div class="sg-icon">
        ...
        ></div>
        <div class="sg-pot"></div>
        <div class="sg-text">最高日排水量（万m3）</div>
        <div class="sg-num">26</div>
        <div class="clear">
          <div
            style="float:left;margin-left:-2px;border-top:solid 2px #01cef6;border-radius:5px;width:16px"
          ></div>
      ...
      <div class="sg-icon-red">
        ...
        ></div>
        <div class="sg-pot"></div>
        <div class="sg-text">今日排水报警总数</div>
        <div class="sg-num">
          <!-- {{sldata.pumpAlarm}} -->
          109
        </div>
      ...
      <div class="sg-icon">
        ...
        ></div>
        <div class="sg-pot"></div>
        <div class="sg-text">重点排水企业总数</div>
        <div class="sg-num">151</div>
        <div class="clear">
          <div
            style="float:left;margin-left:-2px;border-top:solid 2px #01cef6;border-radius:5px;width:16px"
          ></div>
...
import LiquidfillChart from '@/views/components/liquidfillChart.vue' */
export default {
    props: {
        theme: String
    },
